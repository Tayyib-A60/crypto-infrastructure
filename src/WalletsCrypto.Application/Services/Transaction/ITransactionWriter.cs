...
namespace WalletsCrypto.Application.Services.Transaction
{
    ...
    {
        Task<string> CreateAsync(string userId, string addressId, string transactionAddress, decimal transactionAmount, TransactionTypes transactionType = TransactionTypes.Debit, int? index = null,string transactionHash = null);
